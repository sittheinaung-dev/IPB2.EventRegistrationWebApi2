...
namespace IPB2.EventRegistration.Domain.Features.Event
{
    public class EventServices
    {
        ...
        public async Task<EventCreateResponse> CreateEvent(EventCreateRequest request)
        {
            try
            {
                var eventEntity = new IPB2.EventRegistrationWebApi.Database.AppDbContextModels.Event
                {
        ...
        public async Task<EventListResponse> GetEvents(EventListRequest request)
        {
            try
            {
                IQueryable<IPB2.EventRegistrationWebApi.Database.AppDbContextModels.Event> query = _context.Events
